  ...
  <div v-loading.fullscreen.lock="fullscreenLoading">
    <div class="gva-table-box">
      ...
      <el-table :data="tableData1">
        ...
        <el-table-column align="left" label="日期" prop="uploadDate" width="180">
        </el-table-column>
        <el-table-column align="left" label="文件名" prop="fileName" width="350" />
        <el-table-column align="left" label="链接" prop="url" min-width="300" />
        <el-table-column align="left" label="文件类型" prop="fileType" min-width="300" />
       ...
       tableData1: [
        {
          ...
          fileName: "突发公共事件总体应急预案",
          url: "/upload/file/20211001001.pdf",
          fileType:"PDF",
          planLeader: "叶子宁"
        },
        {
          uploadDate: "2021-10-03",
          fileName: "化学工业区市级基层应急管理单元突发事件应急预案",
          url: "/upload/file/20211001002.pdf",
          fileType:"PDF",
          planLeader: "姜宜民"
        },
        {
          ...
          fileName: "消防安全应急预案",
          url: "/upload/file/20211001003.pdf",
          fileType:"PDF",
          planLeader: "曾成仁"
        },
        {
          uploadDate: "2021-10-06",
          fileName: "地震应急预案",
          url: "/upload/file/20211001004.pdf",
          fileType:"PDF",
          planLeader: "钱宇文"
        },
        {
          uploadDate: "2021-10-06",
          fileName: "防汛应急预案",
          url: "/upload/file/20211001005.pdf",
          fileType:"DOC",
          planLeader: "白飞昂"
        },
       ]
